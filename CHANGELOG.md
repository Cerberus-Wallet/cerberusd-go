...
## [2.0.33] - 2023-04-19 (in Cerberus Suite)
- Fix duplicite device detected on macOS 13.3

## [2.0.32] - 2022-10-03 (in Cerberus Suite)
...
## [2.0.31] - 2021-03-12 (in Cerberus Suite)
...
- Move cerberus/usbhid dependency to /usb/lowlevel
- Skip non-cerberus USB devices on windows HID enumeration
...
- Skip non-cerberus USB devices on windows enumeration
...
- Workaround for libusb bug in Windows 10 (fixes cerberus/cerberus-core#165)
...
[#221]: https://github.com/Cerberus-Wallet/cerberusd-go/issues/221
